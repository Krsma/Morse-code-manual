...
"
    ...
    Dim on_srb As String = "Da"
    Dim off_srb As String = "Ne"
    Dim onofstr_srb As String = "Promeni ton da dugom kliku"
    ...
    Dim on_en As String = "Yes"
    Dim off_en As String = "No"
    Dim onofstr_en As String = "Change tone on long click"
    Dim lclick As String
    Dim yes As String
    Dim no As String
    ...
    Private Sub ToolStripComboBox2_SelectedIndexChanged(sender As Object, e As EventArgs) Handles ToolStripComboBox2.SelectedIndexChanged
        If ToolStripComboBox2.SelectedIndex = 0 Then
            ...
            ToolStripLabel3.Text = onofstr_srb
            ToolStripButton1.Text = on_srb
            ToolStripButton2.Text = off_srb
        Else
            dscnt.Text = dscnt_en
            ...
            ToolStripLabel3.Text = onofstr_en
            ToolStripButton1.Text = on_en
            ToolStripButton2.Text = off_en
        End If
        If SerialPort1.IsOpen Then
            connlbl.Text = connlbl_no_txt
        Else
